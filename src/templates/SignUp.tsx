...
const SignUp = () => {
  ...
  const inputUsername = useCallback((event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const inputConfirmPassword = useCallback((event: React.ChangeEvent<HTMLInputElement>) => {
